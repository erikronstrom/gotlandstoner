...
\repeat volta 2 { 
 bes8 d'16 f' bes'8 d'' f''4  | 
 ees''16 d'' c'' bes' c'' bes' a' g' f'8. ees'16  | 
 d' bes' f' bes' d' bes' f' bes' d' bes' f' bes'  | 
 ees' bes' g' bes' ees' bes' g' bes' ees' bes' g' bes'  | 
 e' c'' g' c'' e' c'' g' c'' e' c'' g' c''  | 
 f' c'' a' c'' f' c'' a' c'' f' c'' a' c''  | 
 bes' a' bes' d'' f''8 f' g' ees''  | 
 d''16 f'' a' c'' bes'8 d'' bes4  |
 } %( endrepeat )% 
\repeat volta 2 { 
 f'8 a'16 c'' f''8 a'' c'''4  | 
