...
\usepackage{babel}
\usepackage{xfrac}
\hyphenation{alfa-betet}
\hyphenation{åter-givande}
\hyphenation{lands-måls-alfa-betets}
\hyphenation{tecken-kombinationer}
\hyphenation{lätt-hanterlig}
\begin{document}
...
\sloppy
Någon vetenskapligt tillfredsställande ock i praktiken någorlunda  % Något -> Någon
